...
public val MyIconPack.`More-v-circle`: ImageVector
    get() {
        ...
        `_more-v-circle` = Builder(name = "More-v-circle", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF41416e)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.25f, 1.25f, 0.0f, false, true, 12.0f, 17.75f)
                close()
                moveTo(12.0f, 13.25f)
                ...
                close()
                moveTo(12.0f, 8.75f)
                arcTo(1.25f, 1.25f, 0.0f, true, true, 13.25f, 7.5f)
                arcTo(1.25f, 1.25f, 0.0f, false, true, 12.0f, 8.75f)
                close()
            }
        }
        .build()
