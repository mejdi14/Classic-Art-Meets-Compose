...
public val UnselectedIcons.`Chevron-right`: ImageVector
    get() {
        ...
        `_chevron-right` = Builder(name = "Chevron-right", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF41416e)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(17.354f, 12.353f)
                lineToRelative(-9.0f, 9.0f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, -0.708f, -0.707f)
                lineTo(16.293f, 12.0f)
                lineTo(7.646f, 3.353f)
                arcToRelative(0.5f, 0.5f, 0.0f, false, true, 0.708f, -0.707f)
                lineToRelative(9.0f, 9.0f)
                arcTo(0.5f, 0.5f, 0.0f, false, true, 17.354f, 12.353f)
                close()
            }
        }
        .build()
