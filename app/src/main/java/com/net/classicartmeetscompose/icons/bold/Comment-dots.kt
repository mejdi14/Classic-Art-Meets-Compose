...
public val HomeIcon.`Comment-dots`: ImageVector
    get() {
        ...
        `_comment-dots` = Builder(name = "Comment-dots", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF41416e)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.25f, 11.0f)
                arcTo(1.25f, 1.25f, 0.0f, true, true, 8.0f, 9.75f)
                arcTo(1.25f, 1.25f, 0.0f, false, true, 9.25f, 11.0f)
                close()
                moveTo(13.25f, 11.0f)
                arcTo(1.25f, 1.25f, 0.0f, true, true, 12.0f, 9.75f)
                arcTo(1.25f, 1.25f, 0.0f, false, true, 13.25f, 11.0f)
                close()
                moveTo(17.25f, 11.0f)
                arcTo(1.25f, 1.25f, 0.0f, true, true, 16.0f, 9.75f)
                arcTo(1.25f, 1.25f, 0.0f, false, true, 17.25f, 11.0f)
                close()
            }
        }
        .build()
