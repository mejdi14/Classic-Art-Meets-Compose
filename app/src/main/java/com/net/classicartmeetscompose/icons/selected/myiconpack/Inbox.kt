...
public val SelectedIcons.Inbox: ImageVector
    get() {
        if (_inbox != null) {
            return _inbox!!
        }
        _inbox = Builder(name = "Inbox", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF41416e)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(7.25f, 10.0f)
                arcTo(0.75f, 0.75f, 0.0f, false, true, 8.0f, 9.25f)
                horizontalLineToRelative(8.0f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, 0.0f, 1.5f)
                lineTo(8.0f, 10.75f)
                arcTo(0.75f, 0.75f, 0.0f, false, true, 7.25f, 10.0f)
                close()
                moveTo(9.0f, 7.75f)
                ...
                lineTo(6.5f, 20.5f)
                arcTo(4.505f, 4.505f, 0.0f, false, true, 2.0f, 16.0f)
                lineTo(2.0f, 13.487f)
